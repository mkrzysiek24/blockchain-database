...
from database.models import Block, Doctor, Patient, Transaction


@pytest.fixture
def doctor():
    return Doctor(id=1, name="Dr. Smith", license_number="MED123")


@pytest.fixture
def patient():
    return Patient(id=1, name="John Doe", insurance_number="INS456")
...
def example_block(example_transaction):
    return Block.create_block(transactions=[example_transaction], previous_hash="0" * 64, difficulty=2)
